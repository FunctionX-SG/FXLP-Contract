...
async function main() {
    ...
    // const vestedFX = await upgrades.deployProxy(VestedFX, [stFX], {kind: "uups", timeout: '0', pollingInterval: '1000'});
    ...
    // const multiCall = await upgrades.deployProxy(MultiCall, [], {kind: "uups", timeout: '0', pollingInterval: '1000'});
