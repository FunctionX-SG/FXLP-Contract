...
/*
 * V4 to support switching FX to PundiAI token.
 * Add event CompoundWithFees
 */
contract StakeFXVaultV4 is
    Initializable,
    UUPSUpgradeable,
    PrecompileStaking,
    ...
    BaseVault
{
    ...
    address constant WFX = 0x80b5a32E4F032B2a058b4F29EC95EEfEEB87aDcd;  // Token name is renamed to WPundiAIFX, WFX mainnet: 0x80b5a32E4F032B2a058b4F29EC95EEfEEB87aDcd; WFX testnet: 0x3452e23F9c4cC62c70B7ADAd699B264AF3549C19
    ...
    event CompoundWithFees(address indexed user, uint256 compoundAmount, uint256 feeProtocol, uint256 feeCompounder);
    ...
    */
    function _compound() internal {
        ...
        emit CompoundWithFees(msg.sender, delegateReward, feeProtocol, feeCompounder);
    }
